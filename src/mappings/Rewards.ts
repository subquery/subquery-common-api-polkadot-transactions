...
export async function updateGenericAccountRewards<
  AccountRewardsType extends AccountRewardsInterface,
  AccumulatedRewardClassType extends AccountRewardsInterfaceStatic<AccountRewardsType>
>(
